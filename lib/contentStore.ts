...
const defaultContent: ContentItem[] = [
  ...
  },
  {
    ...
    content: 'Selpic was born from a simple idea: everyone deserves to express their creativity through high-quality, personalised stickers. We started as a small team of designers and developers who were passionate about making custom printing accessible to everyone.',
    order: 6,
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  },
  {
    ...
    content: '7 Harvest St, Mansfield QLD 4122, Australia',
    order: 22,
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  {
    id: 'terms-14-marketplaces',
    type: 'text',
    section: 'terms',
    title: 'Official Store and Marketplaces Title',
    content: 'Official store and third-party marketplaces',
    order: 14.25,
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  {
    id: 'terms-14-marketplaces-content',
    type: 'text',
    section: 'terms',

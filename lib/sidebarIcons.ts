...
export const getIconComponent = (iconName: string) => {
  ...
  const iconImports = {
    ...
    Pulse: () => import('lucide-react').then(mod => mod.Activity),
    ...
    SignalMax: () => import('lucide-react').then(mod => mod.SignalHigh),
    ...
    SpeakerOff: () => import('lucide-react').then(mod => mod.VolumeX),
    ...
    SdCard: () => import('lucide-react').then(mod => mod.HardDrive),
    Cd: () => import('lucide-react').then(mod => mod.Disc),
    Disc: () => import('lucide-react').then(mod => mod.Disc),
    Vinyl: () => import('lucide-react').then(mod => mod.Disc),

-- Document Send Logs (cross-device) for Create & Send Invoice / Quote + Documents
-- Run this in Supabase SQL Editor (same content as migration 20260803100000_document_send_logs.sql).

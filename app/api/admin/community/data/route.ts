...
export async function GET() {
  ...
  try {
    ...
    const postsOut = buildPostsWithComments(posts, commentRows, { includeModeration: true })

    return NextResponse.json({ ok: true, categories, posts: postsOut })
  } catch (e) {
    console.error('[admin/community/data]', e)
